...
import WomanImage from "../../../../assets/images/background-flight.svg";
...
export function FlightConnection() {
  ...
  function handleUptade(connection: any, index: string) {
  ...
  return (
    <div className="flight-connection">
      <div className="flight-connection-text">
        ...
        <h4>
          Olá! Vamos ver se a companhia aérea pode estar te devendo uma
          compensação
        </h4>
      </div>
      ...
      <Modal open={openModal} className="modal">
        <div className="modal-flight-connection">
          <h3>Onde você fez uma conexão ?</h3>
